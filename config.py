...
CELERY_BROKER_URL = 'amqp://$RABBIT_USER:$RABBIT_PASSWORD@$RABBIT_HOST:$RABBIT_PORT/$RABBIT_VHOST'
...
SITES = {
    "api": {"domain": "$TAIGA_HOST$TAIGA_PORT", "scheme": "$TAIGA_SCHEME", "name": "api"},
    "front": {"domain": "$TAIGA_HOST$TAIGA_PORT", "scheme": "$TAIGA_SCHEME", "name": "front"},
}
